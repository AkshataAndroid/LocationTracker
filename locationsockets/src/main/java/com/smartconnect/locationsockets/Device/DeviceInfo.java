package com.smartconnect.locationsockets.Device;
...
public class DeviceInfo {
    ...
    public static String getDeviceId(Context context) {
        String device_uuid = Settings.Secure.getString(getContext.getContentResolver(), Settings.Secure.ANDROID_ID);
      //  String device_uuid = UUID.randomUUID().toString();;
    ...
    public static String getServiceProvider(Context activity) {
        String operatorName = "Service Provider";
        String SimProviderName = "Service Provider";
        TelephonyManager telephonyManager = ((TelephonyManager) activity.getSystemService(Context.TELEPHONY_SERVICE));
        operatorName = telephonyManager != null ? telephonyManager.getNetworkOperatorName() : null;
        SimProviderName = telephonyManager != null ? telephonyManager.getSimOperatorName() : null;
        return operatorName + SimProviderName;
    }

    public static String getcallState(Activity activity) {
